...
def Linear(
    ...
    """
    initialization: None, `lecun`, 'glorot', `he`, 'glorot_he','normal', `orthogonal`, `("uniform", range)`
    """
    with tf.name_scope(name) as scope:
        ...
        if initialization == 'lecun':# and input_dim != output_dim):
            ...
            weight_values=tf.random_normal((input_dim, output_dim), stddev =1.0 / math.sqrt(input_dim) )
